...
func (_c *AuditEventCreate) SetIP(v string) *AuditEventCreate {
	_c.mutation.SetIP(v)
	return _c
}
...
func (_c *AuditEventCreate) SetMeta(v string) *AuditEventCreate {
	_c.mutation.SetMeta(v)
	return _c
}

// SetCreatedAt sets the "created_at" field.
func (_c *AuditEventCreate) SetCreatedAt(v string) *AuditEventCreate {
...
func (_c *AuditEventCreate) check() error {
	...
	if _, ok := _c.mutation.IP(); !ok {
		return &ValidationError{Name: "ip", err: errors.New(`ent: missing required field "AuditEvent.ip"`)}
	}
	...
	if _, ok := _c.mutation.Meta(); !ok {
		return &ValidationError{Name: "meta", err: errors.New(`ent: missing required field "AuditEvent.meta"`)}
	}
