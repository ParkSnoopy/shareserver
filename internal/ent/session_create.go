...
func (_c *SessionCreate) SetAdminID(v int64) *SessionCreate {
	_c.mutation.SetAdminID(v)
	return _c
}

// SetNillableAdminID sets the "admin_id" field if the given value is not nil.
func (_c *SessionCreate) SetNillableAdminID(v *int64) *SessionCreate {
	if v != nil {
		_c.SetAdminID(*v)
	}
	return _c
...
func (_c *SessionCreate) SetCsrf(v string) *SessionCreate {
	_c.mutation.SetCsrf(v)
	return _c
}
...
func (_c *SessionCreate) SetExpiresAt(v string) *SessionCreate {
...
func (_c *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Csrf(); ok {
